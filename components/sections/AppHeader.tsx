      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            className="text-xs font-bold uppercase tracking-widest text-indigo-600 hover:text-indigo-800 transition-colors flex items-center gap-1 cursor-pointer"
          >
          ...
          {onSignOut && (
            <button
              onClick={onSignOut}
              className="rounded-full border border-slate-200 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-slate-500 hover:text-slate-700 hover:border-slate-300 cursor-pointer"
            >
              Sign Out
            </button>
          )}
