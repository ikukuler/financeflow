    ...
    <section className="bg-white px-6 py-4 rounded-3xl shadow-sm border border-slate-200 flex flex-col md:flex-row items-center gap-6">
      ...
      <div className="flex-1 flex flex-wrap items-center gap-4">
        <form onSubmit={handleAddCategory} className="flex items-center gap-2">
          ...
          <button
            type="submit"
            className="bg-slate-800 text-white w-8 h-8 rounded-full flex items-center justify-center hover:bg-slate-900 transition-colors shadow-sm active:scale-90 cursor-pointer"
          >
          ...
          {categories.map((category) => (
            ...
            >
              ...
              <button
                ...
                className="text-slate-300 hover:text-rose-500 transition-colors flex items-center justify-center cursor-pointer"
              >
